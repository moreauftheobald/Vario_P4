...
void setup() {
    ...
    if (imu_calibration_load_from_config()) {
        ...
        if (cal_score >= IMU_CAL_SCORE_EXCELLENT) {
            ...
            Serial.println();
            Serial.println("╔════════════════════════════════════════╗");
            Serial.println("║     CALIBRATION IMU NECESSAIRE         ║");
            Serial.println("║                                        ║");
            Serial.println("║  Poser le variomètre à plat           ║");
            Serial.println("║  et garder immobile pendant 5s         ║");
            Serial.println("╚════════════════════════════════════════╝");
            Serial.println();
        ...
        Serial.println();
        Serial.println("╔════════════════════════════════════════╗");
        Serial.println("║     PREMIERE UTILISATION               ║");
        Serial.println("║                                        ║");
        Serial.println("║  Calibration IMU nécessaire            ║");
        Serial.println("║  Poser à plat et garder immobile 5s    ║");
        Serial.println("╚════════════════════════════════════════╝");
        Serial.println();
        ...
        if (imu_calibration_full()) {
            ...
            Serial.println();
            Serial.println("╔════════════════════════════════════════╗");
            Serial.println("║    CALIBRATION INITIALE REUSSIE !      ║");
            Serial.println("╚════════════════════════════════════════╝");
            Serial.println();
