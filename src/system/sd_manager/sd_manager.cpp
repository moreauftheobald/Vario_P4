...
/**
 * @brief Crée l'arborescence des dossiers système
 * 
 ...
 * - /flights : Traces IGC
 * 
 * @return true si tous créés ou déjà existants, false si erreur
 */
...
/**
 * @brief Convertit le type de carte SD en string lisible
 * @param[in] card_type Type de carte (CARD_MMC, CARD_SD, etc.)
 * @return String descriptif du type
 */
